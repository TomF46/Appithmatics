  ...
  <div class="play flex-container">
    <div class="play-area">
      ...
      <p
        v-if="activeQuestion"
        class="question-text"
      >{{activeQuestion.firstNumber}} {{operand}} {{activeQuestion.secondNumber}}</p>
      <input
        type="tel"
        disabled
        ref="input"
...
export default {
  ...
  methods: {
    ...
    generateQuestions() {
      this.questions = this.questionsService.generateQuestions(
        this.selectedQuestionSet.numberOfQuestions,
        this.selectedQuestionSet.includedNumbers,
        this.selectedQuestionSet.secondaryNumbers,
        this.selectedQuestionSet.operands
      );
