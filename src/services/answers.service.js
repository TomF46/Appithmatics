...
class AnswersService {
    ...
    checkIfCorrect(userAnswer, firstNumber, secondNumber, method){
        ...
        if(method == Methods.Addition) return this.checkAddition(userAnswer, firstNumber, secondNumber);
        if(method == Methods.Subtraction) return this.checkSubtraction(userAnswer, firstNumber, secondNumber);
